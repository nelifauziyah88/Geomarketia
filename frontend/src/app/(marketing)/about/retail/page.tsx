...
function RetailStoreIcon() {
  return (
    <div style={{ position:"relative", width:"100%", maxWidth:540, margin:"0 auto", display:"flex", alignItems:"center", justifyContent:"center" }}>
      <svg viewBox="0 0 540 400" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width:"100%", height:"auto", overflow:"visible" }}>
        <defs>
          <linearGradient id="winGrad1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#60A5FA" stopOpacity="0.35"/><stop offset="100%" stopColor="#1A56DB" stopOpacity="0.15"/></linearGradient>
          <linearGradient id="winGrad2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#34D399" stopOpacity="0.3"/><stop offset="100%" stopColor="#059669" stopOpacity="0.12"/></linearGradient>
          <linearGradient id="winGrad3" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#818CF8" stopOpacity="0.3"/><stop offset="100%" stopColor="#4F46E5" stopOpacity="0.12"/></linearGradient>
          <linearGradient id="groundGrad" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#0B1E5B" stopOpacity="0.9"/><stop offset="100%" stopColor="#040F2E" stopOpacity="0"/></linearGradient>
          <linearGradient id="bldg1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#0D2260"/><stop offset="100%" stopColor="#061540"/></linearGradient>
          <linearGradient id="bldg2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#0A1D52"/><stop offset="100%" stopColor="#050E30"/></linearGradient>
          <linearGradient id="bldg3" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#0C1F58"/><stop offset="100%" stopColor="#060F35"/></linearGradient>
          <linearGradient id="awn1" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stopColor="#1A56DB"/><stop offset="100%" stopColor="#2563EB"/></linearGradient>
          <linearGradient id="awn2" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stopColor="#059669"/><stop offset="100%" stopColor="#10B981"/></linearGradient>
          <linearGradient id="awn3" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stopColor="#4F46E5"/><stop offset="100%" stopColor="#6D28D9"/></linearGradient>
        </defs>
        <rect x="0" y="330" width="540" height="70" fill="url(#groundGrad)"/>
        {[60,120,180,240,300,360,420,480].map((x,i)=><line key={i} x1={x} y1="345" x2={x-20} y2="395" stroke="rgba(96,165,250,0.12)" strokeWidth="1.5"/>)}
        ...
        {[60,80,100,120,140,160,180,200].map((x,i)=><line key={i} x1={x} y1="208" x2={x-4} y2="233" stroke="rgba(255,255,255,0.12)" strokeWidth="4"/>)}
        ...
        {[205,225,245,265,285,305,325,345].map((x,i)=><line key={i} x1={x} y1="212" x2={x-4} y2="237" stroke="rgba(255,255,255,0.12)" strokeWidth="4"/>)}
        ...
        {[350,370,390,410,430,450,470,490].map((x,i)=><line key={i} x1={x} y1="218" x2={x-4} y2="243" stroke="rgba(255,255,255,0.12)" strokeWidth="4"/>)}
        ...
        <g style={{animation:"gmBadgeFloat 3.5s ease-in-out infinite"}}>
          ...
          <text x="16" y="63" fontSize="8" fontWeight="600" fill="rgba(255,255,255,0.38)" fontFamily="'Sora',sans-serif" letterSpacing="0.06em">FOOT TRAFFIC</text>
          <text x="16" y="81" fontSize="17" fontWeight="700" fill="#60A5FA" fontFamily="'Sora',sans-serif">2,840</text>
          <text x="86" y="81" fontSize="9" fontWeight="700" fill="#34D399" fontFamily="'Sora',sans-serif">↑18%</text>
        </g>
        <g style={{animation:"gmBadgeFloat 4s 1s ease-in-out infinite"}}>
          ...
          <text x="418" y="43" fontSize="8" fontWeight="600" fill="rgba(255,255,255,0.38)" fontFamily="'Sora',sans-serif" letterSpacing="0.06em">STORE SCORE</text>
          <text x="418" y="61" fontSize="17" fontWeight="700" fill="#34D399" fontFamily="'Sora',sans-serif">94.2</text>
          <text x="474" y="61" fontSize="9" fontWeight="700" fill="#60A5FA" fontFamily="'Sora',sans-serif">A+</text>
        </g>
        <g style={{animation:"gmBadgeFloat 3.2s 1.8s ease-in-out infinite"}}>
          ...
          <text x="200" y="31" fontSize="8" fontWeight="600" fill="rgba(255,255,255,0.38)" fontFamily="'Sora',sans-serif" letterSpacing="0.06em">MONTHLY REVENUE</text>
          <text x="200" y="49" fontSize="17" fontWeight="700" fill="#818CF8" fontFamily="'Sora',sans-serif">IDR 4.2B</text>
          <text x="306" y="49" fontSize="9" fontWeight="700" fill="#34D399" fontFamily="'Sora',sans-serif">↑23%</text>
        </g>
...
export default function RetailPage() {
  return (
    <main style={{ fontFamily:"'Sora', system-ui, sans-serif", overflowX:"hidden" }}>
      ...
      <section style={{ width:"100%", minHeight:"100vh", background:"#040F2E", position:"relative", overflow:"hidden", display:"flex", alignItems:"center" }}>
        ...
        <div className="gm-hero-grid" style={{ position:"relative", zIndex:2, width:"100%", padding:"6rem 3.5rem 4rem", display:"grid", gridTemplateColumns:"1fr 1fr", gap:"3rem", alignItems:"center", maxWidth:1440, margin:"0 auto" }}>
          <div style={{ animation:"gmFadeUp 0.8s ease both" }}>
            <div style={{ display:"inline-flex", alignItems:"center", gap:8, background:"rgba(26,86,219,0.15)", border:"1px solid rgba(26,86,219,0.45)", borderRadius:100, padding:"5px 14px", marginBottom:24 }}>
              ...
              <span style={{ fontFamily:"'Sora',system-ui,sans-serif", fontSize:11, fontWeight:600, color:"#93C5FD", letterSpacing:"0.07em", textTransform:"uppercase" }}>Retail</span>
            </div>
            <h1 style={{ fontFamily:"'Sora',system-ui,sans-serif", fontWeight:700, fontSize:"clamp(2rem,3.4vw,3.3rem)", lineHeight:1.1, color:"#ffffff", marginBottom:18, letterSpacing:"-0.03em" }}>
              Optimize Store{" "}
              ...
              <br/>with Geospatial Market Intelligence
            </h1>
            <p style={{ fontFamily:"'Sora',system-ui,sans-serif", fontSize:"0.95rem", lineHeight:1.78, color:"rgba(255,255,255,0.55)", marginBottom:36, maxWidth:460 }}>
              Geomarketia enables retail businesses to analyze customer distribution, foot traffic, and location-based factors to choose the best store locations, optimize networks, and increase sales performance.
            </p>
        ...
        <div style={{ maxWidth:1180, margin:"0 auto", padding:"0 2.5rem", position:"relative", zIndex:1 }}>
          ...
          <div style={{ marginBottom:64, maxWidth:560 }}>
            <div style={{ display:"inline-flex", alignItems:"center", gap:8, background:"#EFF6FF", border:"1px solid #BFDBFE", borderRadius:100, padding:"5px 16px", marginBottom:20 }}>
              ...
              <span style={{ fontFamily:"'Sora',sans-serif", fontSize:11, fontWeight:700, color:"#1A56DB", letterSpacing:"0.07em", textTransform:"uppercase" }}>Challenges & Solutions</span>
            </div>
            <h2 style={{ fontFamily:"'Sora',sans-serif", fontWeight:700, fontSize:"clamp(1.75rem,3vw,2.5rem)", color:"#0F172A", letterSpacing:"-0.03em", lineHeight:1.15, marginBottom:14 }}>
              Real Problems.<br/>
              <span style={{ color:"#1A56DB" }}>Data-Driven Solutions.</span>
            </h2>
            <p style={{ fontFamily:"'Sora',sans-serif", fontSize:"0.95rem", lineHeight:1.75, color:"#64748B", margin:0 }}>
              Retail businesses face complex challenges in location selection and store performance. Geomarketia transforms geospatial data into clear, actionable insights to support smarter business decisions.
            </p>
          </div>
